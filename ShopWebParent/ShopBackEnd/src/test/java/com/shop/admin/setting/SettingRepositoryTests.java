...
public class SettingRepositoryTests {
	...
	public void testCreateGeneralSettings() {
		//Setting siteName = new Setting("SITE_NAME","ShopAnh", SettingCategory.GENERAL);
		//Setting siteLogo = new Setting("SITE_LOGO","ShopAnh.png", SettingCategory.GENERAL);
		Setting copyright = new Setting("COPYRIGHT","Copyright (C) 2022 TranAnh Ltd.", SettingCategory.GENERAL);
